                            ...
                            <tbody>
                                @forelse ($ranking as $index => $item)
                                    <tr class="border-b border-border-light dark:border-border-dark hover:bg-gray-50 dark:hover:bg-gray-900 transition">
                                        ...
                                        <td class="px-6 py-4 font-semibold text-text-light dark:text-white">{{ $item['equipo']->nombre }}</td>
                                        ...
                                        <td class="px-6 py-4 text-center">{{ $item['desviacion_estandar'] }}</td>
                                        <td class="px-6 py-4 text-center">{{ $item['calificaciones_count'] }}</td>
                                        <td class="px-6 py-4 text-center">
                                            @if ($item['ganador'])
                                        ...
                                        @if (Auth::user()->esAdmin())
                                            <td class="px-6 py-4 text-center">
                                                ...
                                                @else
                                                    <span class="text-gray-500">Ganador</span>
                                                @endif
                                            </td>
                                        @endif
                                    </tr>
