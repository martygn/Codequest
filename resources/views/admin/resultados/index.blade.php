        ...
        <div class="p-8">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-text-secondary-light dark:text-text-secondary-dark mt-2">Administra y visualiza los resultados detallados de todos los eventos</p>
                </div>
                                        ...
                                        <div class="mb-8">
                                            ...
                                            <div class="grid grid-cols-3 gap-4">
                                                @foreach ($resultado['ranking']->take(3) as $index => $item)
                                                    @php
                                                        $medallasColor = [
                                                            ['bg' => 'from-yellow-400 to-yellow-500', 'medal' => '🥇'],
                                                            ['bg' => 'from-gray-400 to-gray-500', 'medal' => '🥈'],
